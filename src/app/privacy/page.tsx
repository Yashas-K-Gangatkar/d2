...
const sections: Section[] = [
    ...
    content: [
      ...
      },
      {
        ...
        items: [
          ...
          'Support Email: notifetch@notifetch.in',
          'Legal Inquiries: notifetch@notifetch.in',
          'Data Protection Officer (GDPR): notifetch@notifetch.in',
    ...
    content: [
      ...
      },
      {
        ...
        items: [
          ...
          "Request-based deletion: You may also request data deletion by contacting us at notifetch@notifetch.in. We will process verified deletion requests within the timeframes required by applicable law",
        ],
      },
      {
        heading: "Data Export",
        items: [
          ...
          "Export requests can also be made by contacting us at notifetch@notifetch.in. We will provide your data in a structured, commonly used, and machine-readable format within 30 days of verification",
        ],
      },
    ],
  },
  ...
  },
  {
    ...
    content: [
      ...
      },
      {
        ...
        items: [
          "General support and privacy inquiries: notifetch@notifetch.in",
          "Data Protection Officer (GDPR matters): notifetch@notifetch.in",
          "Legal inquiries: notifetch@notifetch.in",
          "Security concerns and vulnerability reports: notifetch@notifetch.in",
          "CCPA rights requests: notifetch@notifetch.in",
          "App Website: https://www.notifetch.in",
        ],
      },
      {
  ...
  },
  {
    ...
    content: [
      ...
      {
        paragraphs: [
          "To file a grievance, please send an email to notifetch@notifetch.in with the subject line \"Data Protection Grievance\" and include your registered email address, a clear description of your grievance, and any relevant supporting information. The Grievance Officer will acknowledge receipt of your grievance within 48 hours and work towards a resolution within the prescribed timeframe.",
        ...
        <Card className="mt-12 bg-gradient-to-br from-amber-500/5 to-orange-600/5 border-amber-500/20">
          <CardContent className="p-6 text-center">
            ...
            <div className="space-y-1.5">
              <a href="mailto:notifetch@notifetch.in" className="block text-amber-500 hover:text-amber-400 font-semibold transition-colors">
                notifetch@notifetch.in
              </a>
              <a href="mailto:notifetch@notifetch.in" className="block text-sm text-muted-foreground hover:text-foreground transition-colors">
                Data Protection Officer: notifetch@notifetch.in
              </a>
              <a href="mailto:notifetch@notifetch.in" className="block text-sm text-muted-foreground hover:text-foreground transition-colors">
                Grievance Officer (India): notifetch@notifetch.in
              </a>
            </div>
          </CardContent>
        </Card>
