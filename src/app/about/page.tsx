        ...
        <Card className="mb-8">
          ...
          <CardContent>
            <div className="space-y-4">
              ...
              <div className="flex items-start gap-3"><Mail className="w-5 h-5 text-muted-foreground mt-0.5" /><div><p className="font-medium">notifetch@notifetch.in</p><p className="text-sm text-muted-foreground">Contact</p></div></div>
            </div>
          </CardContent>
        </Card>
