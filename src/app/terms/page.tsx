            ...
            <CardContent className="p-6">
              ...
              <div className="space-y-4 text-muted-foreground leading-relaxed">
                <p>
                  ...
                  https://www.notifetch.in/privacy, and all applicable laws and regulations. These
            ...
            <CardContent className="p-6">
              ...
              <div className="space-y-4 text-muted-foreground leading-relaxed">
                <p>
                  ...
                  https://www.notifetch.in/privacy, which is incorporated into these Terms by
            ...
            <CardContent className="p-6">
              ...
              <div className="space-y-4 text-muted-foreground leading-relaxed">
                <p>
                  ...
                  contacting us at notifetch@notifetch.in with a written request for account termination.
            ...
            <CardContent className="p-6">
              ...
              <div className="space-y-4 text-muted-foreground leading-relaxed">
                <p>
                  ...
                  request to notifetch@notifetch.in. We will process your deletion request within thirty
            ...
            <CardContent className="p-6">
              ...
              <div className="space-y-4 text-muted-foreground leading-relaxed">
                <p>
                  ...
                  informally by submitting a written complaint to notifetch@notifetch.in with a detailed
            ...
            <CardContent className="p-6">
              ...
              <div className="space-y-4 text-muted-foreground leading-relaxed">
                <p>
                  ...
                  https://www.notifetch.in/terms, unless otherwise specified. The &quot;Last
              ...
              <div className="space-y-4 text-muted-foreground leading-relaxed">
                ...
                <div className="bg-muted/50 rounded-lg p-4 space-y-2">
                  <div className="flex items-center gap-2">
                    ...
                    <a href="mailto:notifetch@notifetch.in" className="text-amber-600 dark:text-amber-400 hover:underline">
                      notifetch@notifetch.in
                    </a>
                  </div>
                  <div className="flex items-center gap-2">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <a href="https://www.notifetch.in" target="_blank" rel="noopener noreferrer" className="text-amber-600 dark:text-amber-400 hover:underline">
                      https://www.notifetch.in
                    </a>
                  </div>
                  <div className="flex items-center gap-2">
                    <ExternalLink className="w-4 h-4 text-amber-500 shrink-0" />
                    <span className="font-medium text-foreground">Privacy Policy:</span>
                    <a href="https://www.notifetch.in/privacy" target="_blank" rel="noopener noreferrer" className="text-amber-600 dark:text-amber-400 hover:underline">
                ...
                <p>
                  ...
                  or the EU GDPR, please submit your request to notifetch@notifetch.in with the subject
